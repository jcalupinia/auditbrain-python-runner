// Canonical, versioned methodology. Shared by the reference page, downloads and prompts.
export const METHODOLOGY_VERSION='1.3.1';
export const METHODOLOGY_DATE='2026-09-19';
...
export const manualSections=[
 ...
 section('sistemas','02 · Distribución entre sistemas',[],['Sistema','Responsabilidad','Salida y límite'],[
 ...
 section('independencia','02A · Independencia del modo de IA',[
 ...
 section('marco','03 · Primera pregunta: PYMES o completas',[
 ...
 section('encargo','04 · Ficha común y herencia',[
 ...
 section('investigacion','05 · Investigación antes de pedir archivos',[
 ...
 section('requerimiento','05A · Requerimiento estructurado en ítems',[
 ...
 section('pantalla','06 · Distribución estándar de la pantalla',[],['Zona','Contenido y propósito'],[
 ...
 section('controles','07 · Catálogo reusable de botones y opciones',[
 ...
 section('fuentes','08 · Ingreso, extracción y validación',[
 ...
 section('estados','09 · Lógica de ejecución y estados',[],['Estado objetivo','Entrada / operación','Salida o bloqueo'],[
 ...
 section('calculos','10 · Cálculos, diferencias y ajustes',[
 ...
 section('excel','11 · Cédulas y formato premium',[
 ...
 section('vnr','12 · Aplicación de referencia: inventarios y VNR',[
 ...
 section('fiscal','13 · Obligaciones Fiscales: patrón observado y brechas',[
 ...
 section('limpieza','14 · Descarga, almacenamiento y Encerar',[
 ...
 section('contrato','15 · Contrato técnico para módulos Python',[
 ...
 section('calidad','16 · Criterios de aceptación y recorrido de prueba',[],['Caso','Resultado exigido'],[
 ...
 section('memoria','17 · Memoria operativa y control de cambios',[
 ...
 'Para actualizar: proponer cambio concreto, comprobar coherencia con decisiones del responsable, modificar la fuente canónica, incrementar versión, regenerar documentos, revisar la ficha y consultas y publicar. Conservar changelog. Versión 1.0.0: primera consolidación del método confirmado por el usuario. Versión 1.1.0: ficha reutilizable, alcance de edición, extracción documental, revisión de evidencia, notas de cálculo y encerado recuperable incorporados al sitio. Versión 1.2.0: ChatGPT predeterminado, independencia de modos opcionales, contexto portable y M16; revisión y reconstrucción de Excel existente con diagnóstico NIIF/NIA, intercambio con cualquier modelo, confirmación del diseño y nueva versión separada del original.'
 ]),
 section('estado','18 · Estado y decisiones pendientes',[],['Elemento','Situación de esta entrega'],[
 ...
 ['GitHub y AUDIT-IA','No se crea un repositorio ni se despliega un módulo Python nuevo en esta actualización del sitio.'],
 ...
 section('referencias','19 · Fuentes y trazabilidad de esta arquitectura',[
