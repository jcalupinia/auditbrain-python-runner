    ...
    "steps": [
        {
            ...
            "engine_ref": "backend.app.aud.inventarios_vnr.app_adapters.extraer_inventario",
            "inputs": ["inventario"],
        ...
        {
            "id": "calcular_vnr",
            "engine_ref": "backend.app.aud.inventarios_vnr.app_adapters.calcular_vnr",
            "inputs": ["filas_inventario"],
        ...
        },
        {
            ...
            "engine_ref": "backend.app.aud.inventarios_vnr.app_adapters.papel_trabajo_excel",
        ...
        },
        {
            ...
            "engine_ref": "backend.app.aud.inventarios_vnr.app_adapters.papel_trabajo_html",
            "inputs": ["resultado_vnr"],
            "produces": "html_bytes",
