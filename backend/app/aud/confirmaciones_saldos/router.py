...
El envío efectivo lo realiza el auditor (enlaces de correo del HTML) o el servicio de
correo de la plataforma consumiendo el manifiesto de envío; este adaptador no envía correo.
"""
import json
...
from .exports import build_xlsx, build_html, build_docx, schedules
