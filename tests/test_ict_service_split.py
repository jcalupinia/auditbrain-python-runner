...
def test_internal_sheets_constant_documents_separation_rule():
    ...
    Includes both the legacy review sheets (VERIFICACIÓN A1, AUDITORÍA DE
    ANEXOS, TRAZABILIDAD) and the new IA-powered artifacts (ARTEFACTO A1,
    ARTEFACTO AUDITORIA) generated by the LLM interpreter pipeline.
    """
    expected = {
        "VERIFICACIÓN A1", "AUDITORÍA DE ANEXOS", "TRAZABILIDAD",
        "ARTEFACTO A1", "ARTEFACTO AUDITORIA",
    }
