"""Ejemplos de requerimiento y ejercicio modelo del Lote 3 (6 herramientas).
...
LOTE1 = [
    "nomina_beneficios", "ingresos_contratos", "gastos_analisis",
    "provisiones_contingencias", "impuesto_corriente_diferido", "patrimonio",
]
